                ...
                <form action="<%=basePath%>toUpdateMessageResult" class="am-form am-form-horizontal" method="post"
                    ...
                    <div class="am-form-group">
                        <label class="am-u-sm-3 am-form-label">
                            标题 </label>
                        <div class="am-u-sm-9">
                            <input type="text" id="doc-vld-ctn-1" required placeholder="请输入标题名称"
                                   name="messageTitle" value="${messageInfo.messageTitle}"> <small>输入标题名称</small>
                        </div>
                    </div>
                    <div class="am-form-group">
                        <label class="am-u-sm-3 am-form-label">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" id="doc-vld-ctn-2" required placeholder="请输入作者姓名"
                                   name="authorName"  data-equal-to="#doc-vld-ctn-2" value="${messageInfo.authorName}" >
                            <small>输入作者姓名</small>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        <label class="am-u-sm-3 am-form-label">
                            主体内容 </label>
<%--                        <div class="am-u-sm-9">--%>
<%--                            <input type="text" id="doc-vld-ctn-3" required placeholder="请输入主题内容"--%>
<%--                                   name="productContent"  data-equal-to="#doc-vld-ctn-3"  value="${messageInfo.productContent}">--%>
<%--                            <small>输入主体内容</small>--%>
<%--                        </div>--%>
